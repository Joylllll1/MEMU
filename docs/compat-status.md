...
| PA4 final MENU/NWM foreground switching | PA4 | open | 2026-07-18 | The GitBook final demo still needs process creation, fd duplication, and multiple concurrent Navy apps; MEMU's real CTE/timer/Sv32 smoke gates pass, but this integrated desktop workflow is not claimed complete |
